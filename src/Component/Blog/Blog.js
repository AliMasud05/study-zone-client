...
const Blog = () => {
    return (
        <div>
          <div>
            <h2 className='text-2xl'>What is 'cors'? </h2>
          ...
          <div>
          <h2 className='text-2xl'>Why are you using firebase ? What other options do you have to implement
              authentication?</h2>
          ...
          <h3 className='text-2xl'>other option of Authentication:</h3>
          <p>Okta</p>
          <p>Supabase</p>
          <p>Ory</p>
          <p>STYTCH</p>
          ...
          <div>
          <h2 className='text-2xl'>How does the private route work?
            </h2>
